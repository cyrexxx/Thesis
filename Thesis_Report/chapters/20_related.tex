...
** write about supervised learning vs un supervised learning\\
...
Two numbers are said to be in the golden ratio if their ratio is same as the ratio of their sum to the larger of the two quantities.Assuming b > a then this can be expressed as\cite{Gill81MurrayWright}:\\
